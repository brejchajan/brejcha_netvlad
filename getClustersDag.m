function clsts= getClustersDag(net, opts, clstFn, k, dbTrain, trainDescFn, layerName)
    ...
    if ~exist(clstFn, 'file')
        ...
        if ~exist(trainDescFn, 'file')
            ...
            outputs = brejcha_getOutputIndicesDag(net, layerName); 
            net.mode = 'test';
            ...
            % move back to CPU addLayersDag() assumes it
            if opts.useGPU
                net.move('cpu');
            end
