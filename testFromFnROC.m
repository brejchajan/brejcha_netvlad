function [fraction, Ns, opts]= testFromFnROC(db, dbFeatFn, qFeatFn, opts, varargin)
    ...
    [fraction, Ns]= testCoreROC(db, qFeat, dbFeat, 'nTestSample', opts.nTestSample, 'recallNs', opts.recallNs);
end
